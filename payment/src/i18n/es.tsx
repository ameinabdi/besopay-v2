const es = {
  ...
  entities: {
    entity: {
        ...
        label: 'Entities',
        menu: 'Entities',
        exporterFileName: 'exportacion_entity',
        list: {
          menu: 'Entities',
          title: 'Entities',
        },
        create: {
          success: 'Entity guardado con éxito',
        },
        update: {
          success: 'Entity guardado con éxito',
        },
        destroy: {
          success: 'Entity eliminado con éxito',
        },
        destroyAll: {
          success: 'Entity(s) eliminado con éxito',
        },
        edit: {
          title: 'Editar Entity',
        },
        fields: {
          ...
          'relationToUsers': 'RelationToUsers',
          'files': 'Files',
          'images': 'Images',
          createdAt: 'Creado el',
        ...
        importer: {
          ...
          fileName: 'entity_import_template',
          hint:

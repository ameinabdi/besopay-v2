...
export default class WithdrawService {
  ...
  async create(data) {
    ...
    try {
      data.bankAccount = await BusinessAccountsRepository.filterIdInTenant(data.bankAccount, { ...this.options, transaction });
  ...
  async update(id, data) {
    ...
    try {
      ...
      const record = await WithdrawRepository.update(
        id,
        data,
        {
          ...this.options,
  ...
  async findAndCountAll(args) {
    return WithdrawRepository.findAndCountAll(
      args,
      this.options,
    );
  }

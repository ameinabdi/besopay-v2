...
export default class TenantService {
   ...
   * to new users.
   */
  async OnboardNewTenant(data, transaction) {
    ...
    console.log('rrrrrrrrrrr',data, record)
  ...
  async create(data) {
    ...
    try {
      ...
      let adminRoles = await RolesRepository.create(
        {
          roles:'Admin',
          description:'Admin',
      ...
      await UserRepository.updateCurrentTenant(
        record,
        {
          ...this.options,
          transaction,
  ...
  async update(id, data) {
    const transaction:any = await SequelizeRepository.createTransaction(
      this.options.database,
    );

...
const ptBR = {
  ...
  entities: {
    entity: {
      errors: {
        unique: {
          text: 'Text deve ser único',
          integer: 'Integer deve ser único',
          decimal: 'Decimal deve ser único',
          date: 'Date deve ser único',
          datetime: 'Datetime deve ser único',
          enumerator: 'Enumerator deve ser único',
          relationToOne: 'RelationToOne deve ser único',
          relationToOneId: 'RelationToOne deve ser único',
          relationToUser: 'RelationToUser deve ser único',
          relationToUserId: 'RelationToUser deve ser único',
        }
      }
    },
    roles: {

const es = {
  ...
  entities: {
    entity: {
      errors: {
        unique: {
          text: 'Text debe ser único',
          integer: 'Integer debe ser único',
          decimal: 'Decimal debe ser único',
          date: 'Date debe ser único',
          datetime: 'Datetime debe ser único',
          enumerator: 'Enumerator debe ser único',
          relationToOne: 'RelationToOne debe ser único',
          relationToOneId: 'RelationToOne debe ser único',
          relationToUser: 'RelationToUser debe ser único',
          relationToUserId: 'RelationToUser debe ser único',
        }
      }
    },
    roles: {

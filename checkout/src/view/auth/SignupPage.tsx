...
const SignupPage = (props) => {
  ...
  const onSubmit:any = ({  firstName, lastName, businessName, phoneNumber,  email, password}) => {
    dispatch(
      actions.doRegisterEmailAndPassword(firstName, lastName, businessName, phoneNumber,null, email, password),
    );
  };

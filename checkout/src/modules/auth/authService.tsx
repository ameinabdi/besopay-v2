...
export default class AuthService {
  ...
  static async verifyTwoFA(optToken) {
    const response = await authAxios.put(
      '/auth/verify-two-factory-authentication',
      {
        optToken,
        tenantId: tenantSubdomain.isSubdomain
          ? AuthCurrentTenant.get()
  ...
  static async resendTwoFA() {
    const response = await authAxios.post(
      '/auth/resend-verify-two-factory-authentication',
    );
  ...
  static async updateTenant(data) {
    ...
    const response = await authAxios.put('/update-current-tenant', body);
    return response.data;
  }

  static async permissionCheck(data) {
    const body = {
      data,
    }
    const response = await authAxios.post('/auth/permission-check', body);
    return response.data;
  }

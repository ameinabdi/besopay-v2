const ptBR = {
  ...
  entities: {
    entity: {
        ...
        label: 'Entities',
        menu: 'Entities',
        exporterFileName: 'Entity_exportados',
        list: {
          menu: 'Entities',
          title: 'Entities',
        },
        ...
        destroy: {
          success: 'Entity deletado com sucesso',
        },
        destroyAll: {
          success: 'Entity(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Entity',
        },
        ...
        view: {
          title: 'Visualizar Entity',
        },
        importer: {
          title: 'Importar Entities',
          fileName: 'entity_template_importacao',
          hint:

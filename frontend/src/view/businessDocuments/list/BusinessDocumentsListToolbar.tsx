...
const BusinessDocumentsToolbar = (props) => {
 const dispatch = useAppDispatch();
  ...
  const hasPermissionToCreate = useSelector(
    businessDocumentsSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    businessDocumentsSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      {hasPermissionToCreate && (
        <Link to="/business-documents/new">
      ...
      {hasPermissionToImport && (
        <Link to="/business-documents/importer">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=businessDocuments">
...
export default BusinessDocumentsToolbar;

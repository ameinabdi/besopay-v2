...
const previewRenders = {
  type: {
    ...
    render: filterRenders.enumerator('entities.businessDocuments.enumerators.type',),
  },
}

const BusinessDocumentsListFilter = (props) => {
...
export default BusinessDocumentsListFilter;
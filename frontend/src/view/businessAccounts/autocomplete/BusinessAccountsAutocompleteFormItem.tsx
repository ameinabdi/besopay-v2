...
import BusinessAccountsFormModal from 'src/view/businessAccounts/form/BusinessAccountsFormModal';
...
const BusinessAccountsAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return BusinessAccountsService.listAutocomplete(value, limit);
  };
...
export default BusinessAccountsAutocompleteFormItem;

...
const schema = yup.object().shape({
  bankAccount: yupFilterSchemas.relationToOne(
    i18n('entities.withdraw.fields.bankAccount'),
  ),
  amountRange: yupFilterSchemas.decimalRange(
    i18n('entities.withdraw.fields.amountRange'),
  ),
  description: yupFilterSchemas.string(
    i18n('entities.withdraw.fields.description'),
  ),
  paidRange: yupFilterSchemas.datetimeRange(
    i18n('entities.withdraw.fields.paidRange'),
  ),
});
...
const previewRenders = {
  ...
  amountRange: {
    label: i18n('entities.withdraw.fields.amountRange'),
  ...
  paidRange: {
    label: i18n('entities.withdraw.fields.paidRange'),
    render: filterRenders.datetimeRange(),
  },
}

const WithdrawListFilter = (props) => {
...
export default WithdrawListFilter;
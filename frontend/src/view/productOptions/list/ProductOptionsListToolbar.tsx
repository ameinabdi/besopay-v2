...
const ProductOptionsToolbar = (props) => {
 const dispatch = useAppDispatch();
  ...
  const hasPermissionToCreate = useSelector(
    productOptionsSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    productOptionsSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToImport && (
        <Link to="/product-options/importer">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=productOptions">
...
export default ProductOptionsToolbar;

...
import ProductOptionsFormModal from 'src/view/productOptions/form/ProductOptionsFormModal';
...
const ProductOptionsAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return ProductOptionsService.listAutocomplete(value, limit);
  };
...
export default ProductOptionsAutocompleteFormItem;

...
import PaymentFormModal from 'src/view/payment/form/PaymentFormModal';
...
const PaymentAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return PaymentService.listAutocomplete(value, limit);
  };
...
export default PaymentAutocompleteFormItem;

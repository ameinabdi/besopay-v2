...
import PaymentMethodFormModal from 'src/view/paymentMethod/form/PaymentMethodFormModal';
...
const PaymentMethodAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return PaymentMethodService.listAutocomplete(value, limit);
  };
  ...
  const mapper = {
    toAutocomplete(value) {
      ...
      if (value.paymentMethodDescription) {
        label = value.paymentMethodDescription;
      }
...
export default PaymentMethodAutocompleteFormItem;

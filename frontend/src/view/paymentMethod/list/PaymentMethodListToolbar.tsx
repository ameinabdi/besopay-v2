...
const PaymentMethodToolbar = (props) => {
 const dispatch = useAppDispatch();
  ...
  const hasPermissionToCreate = useSelector(
    paymentMethodSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    paymentMethodSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToImport && (
        <Link to="/payment-method/importer">
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=paymentMethod">

...
import PaymentLinkFormModal from 'src/view/paymentLink/form/PaymentLinkFormModal';
...
const PaymentLinkAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return PaymentLinkService.listAutocomplete(value, limit);
  };
  ...
  const mapper = {
    toAutocomplete(value) {
      ...
      if (value.paymentLinkName) {
        label = value.paymentLinkName;
      }
...
export default PaymentLinkAutocompleteFormItem;

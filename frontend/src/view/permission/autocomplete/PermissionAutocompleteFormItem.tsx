...
import PermissionFormModal from 'src/view/permission/form/PermissionFormModal';
...
const PermissionAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return PermissionService.listAutocomplete(value, limit);
  };
...
export default PermissionAutocompleteFormItem;
